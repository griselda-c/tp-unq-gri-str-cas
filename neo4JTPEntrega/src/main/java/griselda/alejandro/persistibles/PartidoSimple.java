...
public class PartidoSimple extends Partido {
    ...
    public Persistible completeObjectWithNode(Node nodo) {
        ...
        if (BaseDeDatos.existe(PartidoSimple.class, idNodo)) {
            return BaseDeDatos.detectar(PartidoSimple.class, idNodo);
        } else {
            this.id = idNodo;
            ...
            System.out.println("se setea equipo 1 " + this.equipo1);
    ...
    public Equipo getGanador() {
    	//System.out.println("se compara " +  getGolesEquipo1() + " con " + getGolesEquipo2());        
        if (getGolesEquipo1() > getGolesEquipo2()) {
        	//System.out.println("se retorna " + getEquipo1());
            return getEquipo1();
        } else  if (getGolesEquipo2() > getGolesEquipo1()){
        	//System.out.println("se retorna " + getEquipo2());
            return getEquipo2();
        } else{
        	return null;
        }
