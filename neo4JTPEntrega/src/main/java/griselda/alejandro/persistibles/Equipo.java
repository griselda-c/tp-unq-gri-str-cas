...
public class Equipo implements Persistible {
    ...
    public Equipo() {
        super();
        System.out.println("se crea un equipo con id null");
        this.id = null;
        this.nombre = null;
        this.tecnico = null;
        this.formacion = null;
    ...
    public Equipo(String nombre) {
        super();
        System.out.println("se crea un equipo con nombre" + nombre);
        this.id = null;
        this.nombre = nombre;
        this.tecnico = null;
        this.formacion = null;
    ...
    public Persistible completeObjectWithNode(Node nodo) {
        ...
        if (BaseDeDatos.existe(Equipo.class, idNodo)) {
            ...
            this.id = idNodo;
            System.out.println("se setea el id " + this.id + " en " + this);
            ...
            System.out.println("el equipo se crea correctamente");
    ...
    public void setId(Integer id) {
    	//System.out.println("se setea el id" + id + "en" + this);
        this.id = id;
    }    
